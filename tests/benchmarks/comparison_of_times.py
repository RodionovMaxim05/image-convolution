...
def main() -> None:
    """
    The main function organizes the process of comparative analysis of program execution time with various filters and modes,
    including conducting tests, analyzing results, creating graphs and saving results.
    """
